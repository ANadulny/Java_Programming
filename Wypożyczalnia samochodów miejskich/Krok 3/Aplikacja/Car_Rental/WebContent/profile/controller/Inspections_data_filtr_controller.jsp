...
<body>
	<jsp:useBean id="obj_Inspection_bean" class="bean.Inspection_bean"></jsp:useBean>
	<jsp:setProperty property="*" name="obj_Inspection_bean" />
	...
	<%
		...
		Inspection_modal obj_Inspection_modal=new Inspection_modal();
	    String value = obj_Inspection_modal.inspection_filtr_conditions(obj_Inspection_bean);
	    if(value != ""){
	    	session.setAttribute("inspection_data_display", value);
	    	%>
	    <%
	    } else {
