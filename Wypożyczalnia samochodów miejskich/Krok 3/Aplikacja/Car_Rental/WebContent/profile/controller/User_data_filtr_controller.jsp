...
<body>
	<jsp:useBean id="obj_User_bean" class="bean.User_bean"></jsp:useBean>
	<jsp:setProperty property="*" name="obj_User_bean" />
	...
	<%
		...
		User_modal obj_User_modal=new User_modal();
	    String value = obj_User_modal.user_filtr_conditions(obj_User_bean);
	    if(value != ""){
	    	session.setAttribute("user_data_display", value);
	    	%>
	    <%
	    } else {
