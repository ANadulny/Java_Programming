				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<strong>Write your question to support team</strong> 
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 ">
						 <textarea id='output' placeholder="Message" maxlength="250"></textarea></br>
						 <button style="height:60px;width:100px" onclick="document.getElementById('output').value = ''">Send</button>
					</div>
				</div>
